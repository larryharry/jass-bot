...
from montecarlo.monte_carlo_card_selector import MonteCarloCardSelector


class AgentMonteCarloSchieber(Agent):
    ...
    def action_play_card(self, obs: GameObservation) -> int:
        return MonteCarloCardSelector(self._game_state, 5).calculateBestCardForCurrentPlayer(3)
